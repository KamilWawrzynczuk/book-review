...
class Book extends Model
{
    ...
    public function scopeWithAvarageRating(Builder $query, $from = null, $to = null): Builder | QueryBuilder {
    ...
    public function scopeHighestRated(Builder $query, $from = null, $to = null): Builder | QueryBuilder {
        return $query->withAvarageRating()->orderBy('reviews_avg_rating','desc');
    }
